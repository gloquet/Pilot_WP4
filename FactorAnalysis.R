...
# Data path
data.path <- "C:/Users/loquetg/Documents/DataSet/"
...
#          HEAD_W_V3, JFC_V3, IG55_V3, IG65_V3, IG80_V3, HINT_V4, IDENTIF_V4, NOISE_ANN_V4, HEAD_DIR_V4, HEAD_W_V4, JFC_V4
...
x_axis_lab <- c('PTA','DS','SRT','Region','Sex','Age','HINT_V2','HINT_bin','ACALOS_HTL','ACALOS_MCL','ACALOS_UCL',
                ...
                'HINT_V4','IDENTIF_V4','NOISE_ANN_V4','HEAD_DIR_V4','HEAD_W_V4','JFC_V4')
